...
const uiTranslations = {
  ...
  COSYbrezhoneg: {
    ...
    home: "Degemer",
    practice: "Pleustriñ",
    progress: "Araokadennoù",
    help: "Skoazell",
    choose_language: "Dibab yezh:",
    choose_day: "Dibab deiz:",
    day_from: "Deiz adalek:",
    day_to: "Deiz betek:",
    type_of_practice: "Seurt pleustr:",
    show_practice: "Diskouez ar pleustr",
    xp: "XP",
    streak: "Stur",
    random_word: "Ger dre zegouezh",
    random_image: "Skeudenn dre zegouezh",
    gender: "Grammar",
    verb: "Verb",
  ...
  COSYtatarça: {
    ...
    progress: "Üsüş",
    help: "Yärdäm",
    choose_language: "Tel saylağız:",
    choose_day: "Kön saylağız:",
    day_from: "Kön başlap:",
    day_to: "Kön betkän:",
    type_of_practice: "Däres tibe:",
    show_practice: "Däres kürsätü",
    xp: "XP",
    streak: "Dävamlılıq",
    random_word: "Oçraklı süz",
    random_image: "Oçraklı räsem",
    gender: "Grammar",
    verb: "Fiğel",
    possessives: "İyälek",
    speaking: "Söyläw",
  ...
  COSYbashkort: {
    ...
    progress: "Алға китеү",
    help: "Ярҙам",
    choose_language: "Телде һайлағыҙ:",
    choose_day: "Көндө һайлағыҙ:",
    day_from: "Көндән:",
    day_to: "Көнгә:",
    type_of_practice: "Практика төрө:",
    show_practice: "Практиканы күрһәтеү",
    xp: "XP",
    streak: "Серия",
    random_word: "Осраҡлы һүҙ",
    random_image: "Осраҡлы рәсем",
    gender: "Grammar",
    verb: "Фигыль",
    possessives: "Эйәлек",
    speaking: "Һөйләү",
